...
import com.asuka.admin.dao.UserDao;
...
public class UserServiceImpl extends ServiceImpl<UserDao, User> implements UserService {
	 ...
	 * @see com.asuka.service.UserService#findUserByLoginName(java.lang.String)
	 */
	...
	@Override
	public List<String> findUserRoleNameById(Long id) {


		return baseMapper.findUserRoleNameById(id);
	}
