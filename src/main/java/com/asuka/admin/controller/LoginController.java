...
import com.asuka.admin.util.VerifyCodeUtil;
        ...
        if (StringUtils.isBlank(code) || !trueCode.toLowerCase().equals(code.toLowerCase())) {
            ...
            try {
                ...
                if (user.isAuthenticated()) {
                    AuthRealm.ShiroUser shiroUser = (AuthRealm.ShiroUser) user.getPrincipal();
                    request.getSession().setAttribute("currentUser", shiroUser);
                    map.put("url", "index");
                }
