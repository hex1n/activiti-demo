...
public class UserConteroller extends BaseController {
    ...
    public LayerData<User> list(@RequestParam(value = "page", defaultValue = "1") Integer page,
        ...
        Page<User> userPage;
        userPage = userService.selectPage(new Page<>(page, limit), userEntityWrapper);
        ...
        if (users.size()>0&&users!=null) {
            ...
            for (User user : users) {
                ...
                roleNameList = userService.findUserRoleNameById(user.getId());
