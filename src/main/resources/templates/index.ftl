...
<div class="layui-layout layui-layout-admin">
    ...
    <div class="layui-header header">
        <div class="layui-main">
            ...
            <ul class="layui-nav top_menu">
                ...
                <#--</li>-->
            <#assign currenUser=Session["currentUser"]>
                <li class="layui-nav-item" pc>
                    <a href="javascript:">
                        <img src="<#--<#if (currentUser.icon??)>${currentUser.icon}<#else>-->${base}/static/images/010a131faf5dbc9d65e6236aefbb5d7a_1.jpg<#--</#if>-->" class="layui-circle" width="35" height="35">
                        <cite style="color: red"><#if currentUser.nickName!''>${currentUser.nickName}<#else>${currentUser.loginName}</#if></cite>
                    </a>
    ...
    <div class="layui-side layui-bg-black">
        <div class="user-photo">
            <a class="img" title="我的头像" ><img src="<#--<#if (currentUser.icon??)>${currentUser.icon}<#else>-->${base}/static/images/010a131faf5dbc9d65e6236aefbb5d7a_1.jpg<#--</#if>-->"></a>
            <p>你好！<span class="userName" style="font-size: 10px ;color:red">${currentUser.loginName}</span>, 欢迎登录</p>
        </div>
        ...
        <div class="layui-tab marg0" lay-filter="bodyTab" id="top_tabs_box">
            ...
            <ul class="layui-nav closeBox">
                <li class="layui-nav-item">
                    <a href="javascript:" class="refresh refreshThis"><i class="layui-icon">&#x1002;</i> 刷新当前页</a>
