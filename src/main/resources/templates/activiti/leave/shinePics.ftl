...
<head>
  ...
  <meta name="viewport" content="width=device-width,user-scalable=yes, minimum-scale=0.4, initial-scale=0.8,target-densitydpi=low-dpi" />
    ...
    <link rel="stylesheet" href="${base}/static/zTree/v3/css/metroStyle/metroStyle.css">
    <script type="text/javascript" src="${base}/static/js/jquery.min.js"></script>
    <script type="text/javascript" src="${base}/static/layui/layui.all.js" charset="utf-8"></script>
    <script type="text/javascript" src="${base}/static/js/tools.js" charset="utf-8"></script>
</head>
...
<script>
  ...
  layui.use(['form','layer'], function(){
    $ = layui.jquery;
    //执行AJAX 获取数据
      $.getJSON('${base}/leave/getShineProcImage?processInstanceId=${processInstanceId}', function(json){
