...
<style>
    #darkbannerwrap {
        background: url(../static/images/loginbk.PNG);
        width: 18px;
        height: 10px;
    ...
    .login-bg {
        ...
        background: url(../static/images/loginbk.PNG) no-repeat center;
...
<body class="login-bg">
<div class="login" style="margin-left: 250px;margin-outside: 90px">
    <div class="message">用户登录</div>
    <div id="darkbannerwrap"></div>

    <form class="layui-form" action="${base}/login/main" method="post">
        <div class="layui-form-item">
            <input class="layui-input" name="username" value="" placeholder="请输入用户名" lay-verify="required" type="text"
                   autocomplete="off">
        </div>
        <div class="layui-form-item">
            <input class="layui-input" name="password" value="" placeholder="请输入密码" lay-verify="required"
